            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <h1 className="text-6xl leading-tight font-bold text-black lg:text-7xl">
                    A new way
                    <br />
              ...
              <div className="relative hidden h-96 lg:block">
                ...
                <div className="absolute top-8 right-12 max-w-xs rounded-2xl border border-gray-200 bg-white p-4 shadow-lg">
                ...
                {/* Eric Profile Card */}
                <div className="absolute top-32 right-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-lg">
                ...
                {/* Team Card */}
                <div className="absolute top-4 left-16 rounded-xl border border-gray-200 bg-white p-3 shadow-lg">
